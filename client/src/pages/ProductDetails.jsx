    ...
    return product && (
        <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                                <img src={i<4 ? assets.star : assets.star_blank} className='md:w-4 
                                w-3.5'/>
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                <button onClick={() => navigate("/allproducts")} className='mx-auto cursor-pointer 
                px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition'>
                    See More</button>
            </div>
        </div>
    );
